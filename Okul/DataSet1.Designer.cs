...
namespace Okul.DataSet1TableAdapters {
    ...
    public partial class Tbl_DerslerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Okul.Properties.Settings.Default.BonusOkulConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        Tbl_ogrenciler.Ogrenciid, Tbl_ogrenciler.Ograd, Tbl_ogrenciler.Ogrsoyad, Tbl_Kulupler.Kulupad, Tbl_ogrenciler.Ogrcinsiyet
FROM            Tbl_ogrenciler INNER JOIN
                         Tbl_Kulupler ON Tbl_ogrenciler.Ogrkulup = Tbl_Kulupler.Kulupid";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        Tbl_ogrenciler.Ogrenciid, Tbl_ogrenciler.Ograd, Tbl_ogrenciler.Ogrsoyad, Tbl_Kulupler.Kulupad, Tbl_ogrenciler.Ogrcinsiyet
FROM            Tbl_ogrenciler INNER JOIN
                         Tbl_Kulupler ON Tbl_ogrenciler.Ogrkulup = Tbl_Kulupler.Kulupid
WHERE        (Öğrenciid = @Ogrid)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Ogrid", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO Tbl_ogrenciler\r\n                         (Ograd, Ogrkulup, Ogrsoyad, " +
                "Ogrcinsiyet)\r\nVALUES        (@Ograd,@Ogrkulup,@Ogrsoyad,@Ogrcinsiyet)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE       Tbl_ogrenciler\r\nSET                Ograd = @Ograd, Ogrkulup = @Ogrku" +
                "lup, Ogrsoyad = @Ogrsoyad, Ogrcinsiyet = @Ogrcinsiyet\r\nWHERE        (Ogrenciid =" +
                " @Ogrid)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int FillBy(DataSet1.DataTable1DataTable dataTable, object Ogrid) {
        ...
        public virtual DataSet1.DataTable1DataTable Öğrencigetir(object Ogrid) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Ogrid == null)) {
                throw new global::System.ArgumentNullException("Ogrid");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int ÖğrenciEkle(string Ograd, global::System.Nullable<byte> Ogrkulup, string Ogrsoyad, string Ogrcinsiyet) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((Ograd == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((Ogrkulup.HasValue == true)) {
                command.Parameters[1].Value = ((byte)(Ogrkulup.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int ÖğrenciGüncelleme(string Ograd, global::System.Nullable<byte> Ogrkulup, string Ogrsoyad, string Ogrcinsiyet, int Ogrid) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((Ograd == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int ÖğrenciSil(int v) {
...
SELECT Notid, Dersid, Ogrenciid, Sınav1, Sınav2, Sınav3, Proje, Ortalama, Durum FROM Tbl_Notlar WHERE (Notid = @Notid)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int NotGüncelle(global::System.Nullable<byte> Dersid, global::System.Nullable<int> Ogrenciid, global::System.Nullable<byte> Sınav1, global::System.Nullable<byte> Sınav2, global::System.Nullable<byte> Sınav3, global::System.Nullable<byte> Proje, global::System.Nullable<decimal> Ortalama, global::System.Nullable<bool> Durum, int Original_Notid) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Dersid.HasValue == true)) {
